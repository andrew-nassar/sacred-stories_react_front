...
export function SaintDetailModal() {
  const { selectedSaint, setSelectedSaint, setIsPrayerModalOpen, setDefaultSaintForPrayer, currentTab } = useSacredStore();

  if (!selectedSaint || currentTab === "saint-details") return null;
