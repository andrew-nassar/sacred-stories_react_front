...
export default function LiturgyPlayer() {
  const { isAmbientPlaying: isPlaying, setIsAmbientPlaying: setIsPlaying } = useSacredStore();
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 px-6 py-4 bg-canvas/80 backdrop-filter backdrop-blur-md border-t border-white/5 hidden md:flex items-center justify-between gap-4">
