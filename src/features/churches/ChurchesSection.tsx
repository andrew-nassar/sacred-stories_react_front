...
import { CHURCHES_DATA } from "../../data";
...
export default function ChurchesSection() {
  const { setIsPrayerModalOpen, setDefaultSaintForPrayer } = useSacredStore();

  const handleSanctuarySelect = (churchDedication: string) => {
    setDefaultSaintForPrayer(churchDedication);
          ...
          return (
            ...
            >
              ...
              <div className="p-6 pt-0 border-t border-white/5 mt-4">
                ...
                <button
                  onClick={() => handleSanctuarySelect(church.dedication)}
